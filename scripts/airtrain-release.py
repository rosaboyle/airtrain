...
def copy_changelog():
    ...
    root_dir = os.path.dirname(os.path.dirname(__file__))
    source = os.path.join(root_dir, "changelog.md")
    dest = os.path.join(root_dir, "airtrain", "changelog.md")
    shutil.copy(source, dest)
    print("✅ Copied changelog.md to package directory")
...
def main():
    parser = argparse.ArgumentParser(description='Release airtrain package to PyPI')
