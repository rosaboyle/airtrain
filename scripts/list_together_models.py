#!/usr/bin/env python3
"""
Standalone script to list Together AI models.

This script uses the airtrain library to fetch and display all available models
from Together AI in a tabular format.
"""
...
def list_together_models():
    ...
    try:
        ...
        from airtrain.integrations.together.list_models import (
        ...
        skill = TogetherListModelsSkill(credentials=credentials)
        input_data = TogetherListModelsInput()
        ...
        if HAS_RICH:
            ...
            table = Table(title="Together AI Models")
        ...
        print(f"Error listing Together AI models: {str(e)}")
